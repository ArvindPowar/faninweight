//
//  CotchingViewController.m
//  FanWeighIn
//
//  Created by arvind on 8/24/15.
//  Copyright (c) 2015 arvind. All rights reserved.
//

#import "CotchingViewController.h"
#import "Reachability.h"
@interface CotchingViewController ()

@end

@implementation CotchingViewController
...
- (void)viewDidLoad {
    ...
    CotchingViewController *cotching;
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
    {
        cotching=[[CotchingViewController alloc] initWithNibName:@"CotchingViewController~ipad" bundle:nil];
    ...
    if(height>=480 && height<568){
        ...
        workoutLabel.backgroundColor = [UIColor clearColor];
        workoutLabel.text=@"Cotching Camp";
        workoutLabel.textColor=[UIColor whiteColor];
        UIFontDescriptor * font = [workoutLabel.font.fontDescriptor
                                   fontDescriptorWithSymbolicTraits:UIFontDescriptorTraitBold
                                   | UIFontDescriptorTraitItalic];
...
-(void)getData{
    ...
    NSString *urlString = [[NSString alloc]initWithFormat:@"http://millionairesorg.com/fanweighin/coachingdetails.php"];
